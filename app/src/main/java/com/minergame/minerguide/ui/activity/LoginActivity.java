...
import com.minergame.minerguide.ui.fragment.FragmentLoginPager;
...
import com.minergame.minerguide.utils.Login.OnLoginListener;
import com.minergame.minerguide.utils.Login.SocialNetwork;
import com.minergame.minerguide.utils.Login.SocialUser;
import com.minergame.minerguide.view.pager.CirclePageIndicator;
...
public class LoginActivity extends BaseActivity {
    ...
    private void LoginSocialNetwork(int NetworkType)
    {
        ...
        if(NetworkType==SocialUser.NetworkType.GOOGLEPLUS)
            ...
            socialNetwork=new FacebookLogin(LoginActivity.this);

        socialNetwork.Login(new OnLoginListener() {
            @Override
            public void onSuccess(SocialUser user) {
                Toast.makeText(LoginActivity.this, "Hi, " + user.name + "  " + user.email, Toast.LENGTH_LONG).show();
